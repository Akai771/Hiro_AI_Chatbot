A Discord AI Chatbot that uses the discord.js library to interact with Discord servers and the openAI API to generate human-like responses to user input.
